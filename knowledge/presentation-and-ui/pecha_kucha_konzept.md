...
| **19** | Glossar | **Das Enterprise Acronym Digest (120 Begriffe, Standards & Frameworks)** | Vom SAP-Sprech zu solider Informatik: 120 Begriffe in 12×10-Matrix (inkl. HTML- & HTTP-Versionen, Fiori-zu-HTML5-Korrelation & Web-Frameworks von React bis Web Components), zweizeiligem Label-Layout (Jahr/Name), Toggleswitch (Chronologisch vs. A–Z), 36px-Festhöhe ohne Scrollbalken, Ausbleich-Filterung & Orange-Highlighter |
...
### Folie 19: Das Enterprise Acronym Digest (120 Begriffe, Standards & Frameworks)
* **Visuelles Motiv:** Symmetrisches 12×10-Tableau (12 Zeilen à 10 Spalten, vollständig scrollbar-frei mit 0px Layout-Jumping und harmonischer vertikaler Raumausnutzung): Fester 128px Live-Inspector (`#digestInspector`) oben mit Gegenüberstellung *„SAP-Sprech vs. Informatik-Realität“*. Alle 120 Pills besitzen ein konsistentes zweizeiliges Label-Layout mit fixer 36px Höhe: Zeile 1 zeigt das historische Entstehungs- bzw. Meilensteinjahr (1950–2026), Zeile 2 den Konzeptnamen. Enthält die lückenlose Evolution der HTML-Versionen (`HTML 1.0`, `HTML 2.0`, `HTML 3.2`, `HTML 4.01`, `XHTML`, `HTML5`), der HTTP-Standards (`HTTP/0.9`, `HTTP/1.0`, `HTTP/1.1`, `HTTP/2`, `HTTP/3`) sowie den historischen Übergang von `Web Dynpro` (HTML 4.01) zu `SAPUI5` und `SAP Fiori` (`HTML5`, 2013), flankiert von zeitgenössischen UI-Frameworks (`React`, `AngularJS`, `Bootstrap`, `Vue.js`, `Web Components`, `Next.js`, `Tailwind CSS`, `Flutter`, `Fiori Horizon`). Über einen interaktiven Toggleswitch im Header kann wechselweise zwischen chronologischer Sortierung (nach Jahr) und strikt alphabetischer Sortierung (nach Konzeptname der zweiten Zeile von A–Z) umgeschaltet werden. Interaktive Ausbleich-Filterung (`is-bleached` mit 18% Opazität statt `display:none`) mit 8 Kategorien (inkl. *HTML & Frameworks*), kombiniert mit markantem Orange-Highlighting (`#f97316`) bei Hover/Klick.
* **Kernbotschaft:** Vom Marketing- und SAP-Sprech zu solider, transparenter Informatik – 120 Schlüsselbegriffe der Enterprise-Architektur (von Turing 1950 und SAP R/1 über RFC 9110 HTTP-Codes und HTML5/Fiori bis zu Transformers und modernem Agentic Coding) entschlüsselt, wechselweise nach Zeitstrahl oder Alphabet sortierbar.
* **Sprechertext (20 Sek. / 53 Wörter):**
