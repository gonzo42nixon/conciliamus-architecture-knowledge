...
### Folie 19: Das Enterprise Acronym Digest (170 Meilensteine, Frameworks & Standards)
* **Visuelles Motiv:** Symmetrisches 17×10-Tableau (17 Zeilen à 10 Spalten = exakt 170 Pills, vollständig scrollbar-frei mit 0px Layout-Jumping und vollständiger vertikaler Raumausnutzung der Card-Höhe): Fester 128px Live-Inspector (`#digestInspector`) oben mit Gegenüberstellung *„SAP-Sprech vs. Informatik-Realität“* und dynamischer Impact-Badge (`#inspectImpact`, z. B. `🔥 Impact: 99/100 (Epochal)`). Alle 170 Pills besitzen ein konsistentes zweizeiliges Label-Layout mit fixer 30px Höhe: Zeile 1 zeigt das historische Meilensteinjahr (825–2026), Zeile 2 den Konzeptnamen. Enthält die Ursprünge der Informatik (Al-Chwarizmis Algorithmus 825, Schickards Rechenmaschine 1623, Ada Lovelace 1843, Zuse Z1 1938, ENIAC 1945, Zuses Plankalkül 1945, Bipolartransistor 1947, Alan Turings Test 1950), UNIX (1969, Bell Labs als Urvater aller modernen OS und Cloud-Runtimes), Codds relationales Datenmodell & SQL (1970), Dennis Ritchies C (1972), TCP/IP (1974), DNS (1983), Firmengründungen der großen Hyperscaler (Microsoft 1975, Oracle 1977, Amazon 1994, Google 1998, Alibaba 1999), den Beginn des Cloud-Computing (2006, Eric Schmidt / AWS S3 & EC2), Enterprise Application Integration (EAI, Gartner 1998), Wikipedia (2001), das Semantic Web (Tim Berners-Lee 2001), Docker (2013) und Kubernetes (2014), HTML- und HTTP-Generationen, den Übergang von Web Dynpro zu SAP Fiori (HTML5, 2013) und Web-Frameworks sowie frontier AI-Durchbrüche (Walgesang-KI-Decodierung von Project CETI 2024, DeepSeek Open-Weights 2024, OpenAI Codex Agentic Coding 2025, Google Open Knowledge Format OKF v0.2 für 2026 und General AI).
* **Interaktive Steuerung:** Über einen dreistufigen interaktiven Toggle-Switch im Header kann wechselweise zwischen:
  1. **`📅 Chronologisch`** (nach Entstehungsjahr 825–2026),
  2. **`🔤 A–Z`** (strikt alphabetisch nach Konzeptname der zweiten Zeile), und
  3. **`🔥 Impact`** (nach kalibriertem historischem Bedeutungsindex von 1 bis 100 sortiert, epochale Errungenschaften wie Transistor, UNIX, Algorithmus, WWW oder Cloud-Computing zuerst) umgeschaltet werden.
...
* **Kernbotschaft:** Vom Marketing- und SAP-Sprech zu solider, transparenter Informatik – 170 Schlüsselbegriffe der IT-Geschichte und Enterprise-Architektur (von Al-Chwarizmi 825, Zuse Z1 und UNIX über Hyperscaler-Gründungen und HTML5/Fiori bis zu DeepSeek, OpenAI Codex und Google OKF 2026) entschlüsselt, wechselweise nach Zeitstrahl, Alphabet oder historischem Impact sortierbar.
* **Sprechertext (20 Sek. / 53 Wörter):**
