...
### Folie 19: Das Enterprise Acronym Digest (150 Meilensteine, Frameworks & Standards)
* **Visuelles Motiv:** Symmetrisches 15×10-Tableau (15 Zeilen à 10 Spalten, vollständig scrollbar-frei mit 0px Layout-Jumping und vollständiger vertikaler Raumausnutzung): Fester 128px Live-Inspector (`#digestInspector`) oben mit Gegenüberstellung *„SAP-Sprech vs. Informatik-Realität“*. Alle 150 Pills besitzen ein konsistentes zweizeiliges Label-Layout mit fixer 32px Höhe: Zeile 1 zeigt das historische Entstehungs- bzw. Meilensteinjahr (825–2026), Zeile 2 den Konzeptnamen. Enthält die Ursprünge der Informatik (Al-Chwarizmis Algorithmus 825, Schickards Rechenmaschine 1623, Ada Lovelace 1843, Zuse Z1 1938, ENIAC 1945, Zuses Plankalkül 1945), gesellschaftliche und technologische Pioniere (Esperanto 1954, Moore's Law 1965 & Moore gebrochen 2022, NeXT von Steve Jobs 1985, WWW-Erfindung am CERN 1989, NeXT-Webbrowser 1990), HTML- und HTTP-Generationen, den Übergang von Web Dynpro zu SAP Fiori (HTML5, 2013) und Web-Frameworks sowie frontier AI-Durchbrüche (Walgesang-KI-Decodierung von Project CETI 2024, Neurallingo-Agentensprache 2025). Über einen interaktiven Toggleswitch im Header kann wechselweise zwischen chronologischer Sortierung (nach Jahr) und strikt alphabetischer Sortierung (nach Konzeptname der zweiten Zeile von A–Z) umgeschaltet werden. Interaktive Ausbleich-Filterung (`is-bleached` mit 18% Opazität statt `display:none`) mit 8 Kategorien, kombiniert mit markantem Orange-Highlighting (`#f97316`) bei Hover/Klick.
* **Kernbotschaft:** Vom Marketing- und SAP-Sprech zu solider, transparenter Informatik – 150 Schlüsselbegriffe der IT-Geschichte und Enterprise-Architektur (von Al-Chwarizmi 825 und Zuse Z1 über NeXT und HTML5/Fiori bis zu Quantenüberlegenheit und Neurallingo) entschlüsselt, wechselweise nach Zeitstrahl oder Alphabet sortierbar.
* **Sprechertext (20 Sek. / 53 Wörter):**
